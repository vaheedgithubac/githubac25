...
## 🔹 STEP 11.1 — Generate SSH Key (if you don’t have one) 
```bash
...
## STEP 11.2 — Add Public Key to Git Provider
Example: GitHub   
...
## 🔹 STEP 11.3 — Add Private Repo to Argo CD   
Use the Argo CD CLI:   
```bash
...
## 🔹 STEP 11.4 — Verify Repository Access  
```bash
argocd repo list
```
Expected:   
